...
#ifndef TELEGRAM_CLASS_EMP_DEF  
  #define TELEGRAM_CLASS_EMP_DEF
  

  class TELEGRAM_EMP_CLASS {
    private:
    ...
    public:
        ...
        void runTelegramBot(float EMP_voltage, float ONBOARD_TEMP, float ONBOARD_HUMIDITY);
